...
const DialogEdit = ({ open, setOpen }) => {
  ...
  const handleSubmit = (values, { resetForm }) => {
    ...
    (async () => {
      try {
        ...
        const oldData = await getUser({ username: data.username });

        if (em.result.includes(data.email)) {
          if (data.email !== oldData.result.email) {
  ...
  return (
    <>
      ...
      >
        <DialogTitle>Modificar un usuario</DialogTitle>
